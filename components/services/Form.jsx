...
const Form = () => {
  ...
  return (
    <div className="w-full 2xl:w-1/2 relative border border-salte-300 shadow-md dark:border-slate-500 rounded-md p-4 md:p-16">
      <form className="w-full">
        ...
        {toggle && (
          <div className="form-row form-row-3 border border-stone-300 p-4  rounded-md">
            <div className="form-group">
        ...
        <div className="flex gap-6 justify-end w-full">
          <button
            ...
            className="bg-sky-500 text-sm h-10 px-2 rounded-md"
          >
            ارسال عکس{" "}
          </button>
          <button className="bg-green-500 text-sm text-white h-10 px-2 rounded-md">
            ثبت درخواست{" "}
          </button>
        </div>
      </form>
