...
const CardItemSample = ({ item }) => {
  ...
  return (
    <div className=" z-10 rounded-md">
      ...
      <div className="flex flex-col text-white bg-gray-900 p-4 ">
        <div className="flex justify-between mb-2 border-b pb-3 f-dast">
          <p> {item.name}</p>
...
const ExperienceItem = ({ count, title }) => {
  return (
    <motion.div
      ...
      className="experience__item text-white z-10 mt-24"
    >
