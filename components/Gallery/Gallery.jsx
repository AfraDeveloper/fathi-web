...
const Gallery = () => {
    ...
    const photos = [1, 2, 3, 4, 5, 6, 7, 8].map(img => {
        return { src: `/img/img${img}.webp`, width: 620, height: 420,title:`image ${img}`, description: `Slide description ${img}` }
    })
    ...
    return (
        <div className="w-full px-1 lg:container overflow-hidden mt-32">
            ...
            <div className="my-16 px-4 ">
                <PhotoAlbum spacing={30} layout="rows"  photos={photos} onClick={({ index }) => setIndex(index)} />
                <Lightbox
