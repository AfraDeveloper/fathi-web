...
const Header = () => {
  ...
  outsideClick(lang_btn, lang)
  const handleLcoal = l => {
    push("/", undefined, { locale: l })
    lang.current.classList.remove("active")
  }
  ...
  return (
    <div className="w-full bg-transparent bg-[#344BA8]  shadow-sm  dark:bg-[#10102e]  z-[100] sticky top-0">
      ...
      w-full md:container mx-auto   shadow-lg md:shadow-none">
        ...
        >
          <div className="flex menu_list duration-300 overflow-hidden bg-white dark:bg-slate-800/90 lg:bg-transparent 
          ...
          items-start lg:items-center fixed h-screen lg:h-auto  flex-col lg:flex-row 
            ...
            <Link className="nav__link text-slate-900 dark:text-white lg:text-white" href="#main">
              صفحه اصلی
            </Link>
            <Link className="nav__link text-slate-900 dark:text-white lg:text-white" href="#">
              خدمات
            </Link>
            <Link className="nav__link text-slate-900 dark:text-white lg:text-white" href="#">
              درباره من
        ...
        >
          ...
          <div ref={lang} className="invisible absolute duration-300 bg-white rounded-sm shadow-md scale-0 langs
             pt-4 gap-4 flex flex-col top-10 w-20 h-24  left-0">
            <button className="w-full   text-orange-600 h-6 rounded-md " onClick={() => handleLcoal("fa")}>fa</button>
            <button className="w-full   text-orange-600 h-6 rounded-md " onClick={() => handleLcoal("en")}>en</button>
          </div>
